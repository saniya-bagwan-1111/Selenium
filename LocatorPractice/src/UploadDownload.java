...
public class UploadDownload {
	public static void main(String[] args) throws IOException {
		...
		String fileName = "D:/Selenium/Examples/Excel/download.xlsx";
		...
		upload.sendKeys("D:/Selenium/Examples/Excel/download.xlsx");
	...
	private static int getColumnNumber(String fileName, String colName) throws IOException { 
		...
		k++;
	}System.out.println(coloumn);return coloumn;
}
}